...
export const vi = {
  ...
  'stories.lab.memoryGeneration': 'Thế hệ',
  'stories.lab.memoryOral': 'Truyền miệng',
  'stories.lab.memorySymbolic': 'Ký hiệu',
  'stories.lab.memoryMarks': 'dấu vết',
  'stories.lab.memoryModel': 'Đây là mô hình minh hoạ, không phải phép đo lịch sử.',
  'stories.lab.memoryChart': 'So sánh lưu giữ ký ức',
  'stories.lab.memoryChartDescription': 'Hai cột cho biết số dấu vết còn lại sau mỗi thế hệ.',
  'stories.lab.abacusPrevious': 'Bước trước',
  'stories.lab.abacusNext': 'Bước tiếp',
  'stories.lab.abacusAddBead': 'Thêm một hạt',
  'stories.lab.abacusShowGears': 'Hiện bánh răng',
  'stories.lab.abacusShowAbacus': 'Hiện bàn tính',
  'stories.lab.abacusLabel': 'Bàn tính',
  'stories.lab.abacusGearSequence': 'Chuỗi bánh răng',
  'stories.lab.abacusColumn': 'Cột',
  'stories.lab.abacusCarry': 'nhớ',
  'stories.lab.abacusNoCarry': 'không nhớ',
  'stories.lab.abacusDiagram': 'Trạng thái phép cộng',
  'stories.lab.abacusDiagramDescription': 'Mỗi bước thêm một hạt vào bàn tính.',
  'stories.lab.abacusOnes': 'hàng đơn vị',
  'stories.lab.abacusTens': 'hàng chục',
  'stories.lab.abacusHundreds': 'hàng trăm',
  'stories.lab.abacusThousands': 'hàng nghìn',
  'stories.lab.abacusRodValue': (place: string, digit: number) => `${place}: ${digit}`,
  'stories.lab.rulesMoveUp': (id: string) => `Đưa ${id} lên`,
  'stories.lab.rulesMoveDown': (id: string) => `Đưa ${id} xuống`,
  'stories.lab.rulesTrace': 'Dấu vết tính toán',
  'stories.lab.rulesCorrect': 'Đúng mục tiêu',
  'stories.lab.rulesIncorrect': 'Kết quả hiện tại không khớp mục tiêu',
  'stories.lab.rulesCard': 'Thẻ quy tắc',
  'stories.lab.rulesCardDescription': 'Thẻ này là một phép toán cố định và xác định.',
  'stories.lab.rulesCardLabel': (position: number) => `Thẻ quy tắc ${position}`,
  'stories.lab.rulesOperationAdd': 'cộng',
  'stories.lab.rulesOperationMultiply': 'nhân',
  'stories.lab.machineTape': 'Băng của máy',
  'stories.lab.machineState': 'Trạng thái',
  'stories.lab.machineHead': 'đầu đọc',
  'stories.lab.machineStep': 'Đi một bước máy',
  'stories.lab.machineStillRunning': (limit: number) => `Máy vẫn đang chạy trong lần quan sát ${limit} bước.`,
  'stories.lab.machineHalted': (steps: number) => `Máy đã dừng sau ${steps} bước quan sát.`,
  'stories.lab.machineBoundReached': (limit: number) => `Lần quan sát đã chạm giới hạn ${limit} bước.`,
  'stories.lab.judgmentTranscript': 'Bản ghi hội thoại',
  'stories.lab.judgmentCriteria': 'Tiêu chí do con người chọn',
  'stories.lab.judgmentFindings': 'Nhận định theo tiêu chí',
  'stories.lab.judgmentChoose': 'Chọn một tiêu chí để xem cùng bản ghi qua một khung đánh giá khác.',
  'stories.lab.judgmentJudge': 'Người hỏi',
  'stories.lab.judgmentRespondent': 'Người trả lời',
  'stories.lab.separatorAngle': 'Góc',
  'stories.lab.separatorOffset': 'Độ lệch',
  'stories.lab.separatorUseXor': 'Dùng các điểm XOR',
  'stories.lab.separatorMisclassified': (count: number) => `Phân loại sai: ${count}`,
  'stories.lab.separatorBoundary': 'Đường phân tách tuyến tính',
  'stories.lab.separatorBoundaryDescription': 'Một đường phân tách và các điểm được phân loại đúng hoặc sai.',
  'stories.lab.separatorTextEquivalent': 'Tương đương bằng văn bản của các điểm',
  'stories.lab.separatorPoint': (position: number) => `Điểm ${position}`,
  'stories.lab.separatorCorrect': 'đúng',
  'stories.lab.separatorWrong': 'sai',
  'stories.lab.separatorXorLimit': 'Một lớp tuyến tính không thể phân tách mọi cách sắp xếp XOR.',
  'stories.lab.knowledgeChangedRule': 'Luật được thay đổi',
  'stories.lab.knowledgeAffectedRules': (count: number) => `${count} luật bị ảnh hưởng`,
  'stories.lab.knowledgeTree': 'Cây luật chuyên gia',
  'stories.lab.knowledgeTreeDescription': 'Cây các luật và nhánh phụ thuộc bị ảnh hưởng.',
  'stories.lab.knowledgeSafety': 'Cây luật đồ chơi này chỉ là minh hoạ, không phải lời khuyên y tế.',
  'stories.lab.gradientRate': 'Tốc độ học',
  'stories.lab.gradientStep': 'Đi một bước',
  'stories.lab.gradientStatus': (x: number, loss: number) => `x ${x}; loss ${loss}`,
  'stories.lab.gradientLandscape': 'Địa hình loss',
  'stories.lab.gradientLandscapeDescription': 'Loss bình phương quanh một mục tiêu cố định.',
  'stories.lab.gradientTimeline': 'Mốc kỳ vọng và tài trợ',
  'stories.lab.gradientTimelineCaveat': 'Mốc này để khám phá độc lập, không phải một đường mùa đông AI toàn cầu.',
  'stories.lab.convolutionInput': 'Ảnh đầu vào',
  'stories.lab.convolutionMoveUp': 'Đưa kernel lên',
  'stories.lab.convolutionMoveDown': 'Đưa kernel xuống',
  'stories.lab.convolutionMoveLeft': 'Đưa kernel sang trái',
  ...
  'stories.lab.convolutionGrouped': 'Các điểm sáng được nhóm chỉ để lấy trực giác, không phải benchmark GPU.',
  'stories.lab.attentionContext': 'Ngữ cảnh',
  'stories.lab.attentionToken': (position: number, token: string) => `Token ${position}: ${token}`,
  'stories.lab.attentionSelectedWeights': (weights: string) => `Trọng số attention đã chọn: ${weights}`,
  'stories.lab.attentionMap': 'Bản đồ trọng số attention',
  'stories.lab.attentionMapDescription': 'Các trọng số được tính sẵn từ token đang chọn đến mọi token trong ngữ cảnh này.',
  'stories.lab.attentionTable': 'Bảng trọng số attention',
  'stories.lab.attentionTokenColumn': 'Token',
  'stories.lab.attentionWeightColumn': 'Trọng số',
  'stories.lab.attentionCaveat': 'Bản đồ attention không phải là lời giải thích đầy đủ cho cách mô hình suy luận.',
  'stories.lab.agentPermissions': 'Các quyền đã cấu hình',
  'stories.lab.agentTrace': 'Dấu vết tác tử',
  'stories.lab.agentComplete': 'hoàn tất',
  'stories.lab.agentBlocked': 'bị chặn',
  'stories.lab.agentAwaitingHuman': 'chờ con người',
  'stories.lab.agentPermission': (permission: string) => `Quyền: ${permission}`,
  'stories.lab.agiFirstDefinition': 'Định nghĩa thứ nhất',
  'stories.lab.agiSecondDefinition': 'Định nghĩa thứ hai',
  'stories.lab.agiGenerality': 'Tính phổ quát',
  'stories.lab.agiCapability': 'Năng lực',
  'stories.lab.agiAutonomy': 'Quyền tự chủ',
  'stories.lab.agiAxis': 'Trục',
  'stories.lab.agiDifferenceTable': 'Khác biệt giữa các định nghĩa',
  'stories.lab.agiDifference': 'Chênh lệch (thứ nhất − thứ hai)',
  'stories.lab.agiConclusion': 'Bất đồng về định nghĩa quan trọng vì người có quyền quyết định sẽ chọn ngưỡng và hệ quả nào được tính.',
  ...
  'landing.question': 'Đọc cho kỹ, chạm để thấy, hỏi đến khi hiểu.',
  'landing.question.read': 'Đọc cho kỹ,',
  'landing.question.touch': 'chạm để thấy,',
  'landing.question.ask': 'hỏi đến khi hiểu.',
  'landing.lede': 'Giáo trình chi tiết, với hình tương tác bạn có thể tự tay thử. Khi muốn đi sâu hơn, gia sư AI đọc đúng bài học và ghi chú của bạn để tiếp tục từ chỗ đang vướng.',
  'landing.read.verb': 'Mở bài học',
  'landing.read.catalog': 'Mở danh mục khoá học',
  'landing.read.meta': 'Đọc miễn phí, không cần tài khoản',
  'landing.account.cta': 'Tạo tài khoản',
  'landing.depth.h': 'Một bài học không chỉ đưa ra đáp án.',
  'landing.depth.p1': 'Giáo trình đi từ trực giác tới lập luận, công thức, ví dụ và bài tập. Một khái niệm được giải thích đủ lâu để bạn thấy vì sao nó đúng, không chỉ nhớ kết quả.',
  'landing.depth.p2': 'Hình tương tác nằm ngay cạnh đoạn cần nó. Thay đổi một tham số để quan sát điều gì đổi, điều gì vẫn giữ nguyên.',
  'landing.depth.caption': 'Chữ là xương sống. Hình và tương tác mở thêm những lớp hiểu.',
  'landing.lab.h': 'Chạm để thấy',
  'landing.lab.copy': 'Kéo mức phân tán và nhìn năm khả năng đổi cùng nhau.',
  'landing.lab.slider': 'Mức độ phân tán',
  'landing.lab.axisFocused': 'tập trung',
  'landing.lab.axisSpread': 'trải đều',
  'landing.lab.observation': 'Điều đang quan sát',
  'landing.lab.focused': 'Một khả năng đang nổi trội.',
  'landing.lab.mixed': 'Các khả năng đang dần trải rộng.',
  'landing.lab.even': 'Các khả năng đang gần ngang nhau.',
  'landing.lab.figure': 'Biểu đồ năm khả năng thay đổi theo mức độ phân tán.',
  'landing.demo.h': 'Vẫn còn vướng? Hỏi ngay trong bài.',
  'landing.demo.intro': 'Bôi đen đúng câu khiến bạn dừng lại. Ghi một dòng về điều chưa rõ. Gia sư đọc bài học cùng ghi chú ấy trước khi trả lời.',
  'landing.demo.example': 'Ví dụ trong một bài học',
  'landing.demo.sentence': 'Một khả năng càng khó đoán thì lượng thông tin khi quan sát nó càng lớn.',
  'landing.demo.noteLabel': 'Ghi chú của bạn',
  'landing.demo.note': 'Tại sao khó đoán lại có nhiều thông tin hơn?',
  'landing.demo.tutorLabel': 'Gia sư',
  'landing.demo.tutor': 'Nếu kết quả đã chắc chắn, quan sát nó không cho ta điều mới. Kết quả càng bất ngờ, ta càng học được nhiều từ lần quan sát ấy.',
  'landing.note.how': 'Ghi chú bám vào câu; câu trả lời bắt đầu từ đúng chỗ bạn đang nghĩ.',
  'landing.note.hover': 'Rê chuột lên ghi chú để thấy nét nối trở về câu gốc.',
  'landing.vision.figure': 'Tranh bút chì và màu nước: một giáo trình kỹ thuật mở trên bàn, với sơ đồ, đồ thị và một nét vàng nối từ câu chữ qua các hình minh hoạ.',
  'landing.catalog.h': 'Chọn một cuốn để bắt đầu.',
  'landing.catalog.error': 'Không tải được danh mục khoá học lúc này.',
  'landing.catalog.retry': 'Thử lại',
  'landing.catalog.all': 'Mở toàn bộ danh mục',
  'landing.footer.h': 'Còn một điều chưa hiểu?',
  'landing.footer.start': 'Bắt đầu từ đó.',
  ...
  'login.legal.lead': 'Khi tạo tài khoản, bạn đồng ý với',
  'login.legal.terms': 'Điều khoản sử dụng',
  'login.legal.and': 'và',
