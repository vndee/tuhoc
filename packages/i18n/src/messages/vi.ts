...
export const vi = {
  ...
  'landing.question': 'Nơi bạn tự học và tự đào sâu — với AI hỗ trợ đúng chỗ bạn mắc.',
  'landing.lede': 'Đọc giáo trình miễn phí, không cần tài khoản. Bôi đen một câu là ghi chú dính vào đúng câu ấy — và gia sư AI trả lời ngay tại đó.',
  'landing.read.h': 'Đọc',
  ...
  'landing.ask.margin.p': 'Ghi chú của bạn — mặc định bật, tắt được trong Cài đặt. Trả bằng credit của tài khoản; không cần key riêng.',
  ...
  'landing.vision.body': 'Một cuốn sách hay là xương sống, không phải trần nhà. Người học vẫn là người làm việc; AI chỉ làm cho việc ấy đi xa hơn.',
  'landing.vision.figure': 'Hình vẽ phấn: một người ngồi học trước cuốn sách mở, và quanh họ là những thứ đang học — một mạng nơ-ron, vài công thức, một hành tinh có vành và mấy ngôi sao.',
  'landing.can.h': 'Bạn làm được gì ở đây',
  'landing.can.read': 'Đọc — giáo trình dài, công thức, hình tương tác. Miễn phí.',
  'landing.can.note': 'Ghi — bôi đen một câu, ghi chú dính vào đúng câu đó.',
  'landing.can.ask': 'Hỏi — gia sư trả lời ngay trong bài, đọc được ghi chú của bạn.',
  'landing.can.return': 'Quay lại — mở máy nào cũng đúng chỗ đang dở.',
