...
export const en: Messages = {
  ...
  'stories.lab.memoryGeneration': 'Generation',
  'stories.lab.memoryOral': 'Oral',
  'stories.lab.memorySymbolic': 'Symbolic',
  'stories.lab.memoryMarks': 'marks',
  'stories.lab.memoryModel': 'This is an illustrative model, not a historical measurement.',
  'stories.lab.memoryChart': 'Memory retention comparison',
  'stories.lab.memoryChartDescription': 'Two columns show the marks retained after each generation.',
  'stories.lab.abacusPrevious': 'Previous step',
  'stories.lab.abacusNext': 'Next step',
  'stories.lab.abacusAddBead': 'Add a bead',
  'stories.lab.abacusShowGears': 'Show gears',
  'stories.lab.abacusShowAbacus': 'Show abacus',
  'stories.lab.abacusLabel': 'Abacus',
  'stories.lab.abacusGearSequence': 'Gear sequence',
  'stories.lab.abacusColumn': 'Column',
  'stories.lab.abacusCarry': 'carry',
  'stories.lab.abacusNoCarry': 'no carry',
  'stories.lab.abacusDiagram': 'Addition state',
  'stories.lab.abacusDiagramDescription': 'Each step adds one bead to the abacus.',
  'stories.lab.abacusOnes': 'ones',
  'stories.lab.abacusTens': 'tens',
  'stories.lab.abacusHundreds': 'hundreds',
  'stories.lab.abacusThousands': 'thousands',
  'stories.lab.abacusRodValue': (place: string, digit: number) => `${place} rod: ${digit}`,
  'stories.lab.rulesMoveUp': (id: string) => `Move ${id} up`,
  'stories.lab.rulesMoveDown': (id: string) => `Move ${id} down`,
  'stories.lab.rulesTrace': 'Calculation trace',
  'stories.lab.rulesCorrect': 'Matches the target',
  'stories.lab.rulesIncorrect': 'The current output does not match the target',
  'stories.lab.rulesCard': 'Rule card',
  'stories.lab.rulesCardDescription': 'This card is a fixed, deterministic operation.',
  'stories.lab.rulesCardLabel': (position: number) => `Rule card ${position}`,
  'stories.lab.rulesOperationAdd': 'add',
  'stories.lab.rulesOperationMultiply': 'multiply',
  'stories.lab.machineTape': 'Machine tape',
  'stories.lab.machineState': 'State',
  'stories.lab.machineHead': 'head',
  'stories.lab.machineStep': 'Step machine',
  'stories.lab.machineStillRunning': (limit: number) => `Still running within the ${limit}-step observation.`,
  'stories.lab.machineHalted': (steps: number) => `Halted after ${steps} observed steps.`,
  'stories.lab.machineBoundReached': (limit: number) => `The observation reached its ${limit}-step limit.`,
  'stories.lab.judgmentTranscript': 'Conversation transcript',
  'stories.lab.judgmentCriteria': 'Human criteria',
  'stories.lab.judgmentFindings': 'Criterion findings',
  'stories.lab.judgmentChoose': 'Choose a criterion to view the same transcript through a different frame.',
  'stories.lab.judgmentJudge': 'Interviewer',
  'stories.lab.judgmentRespondent': 'Respondent',
  'stories.lab.separatorAngle': 'Angle',
  'stories.lab.separatorOffset': 'Offset',
  'stories.lab.separatorUseXor': 'Use XOR points',
  'stories.lab.separatorMisclassified': (count: number) => `Misclassified: ${count}`,
  'stories.lab.separatorBoundary': 'Linear separator boundary',
  'stories.lab.separatorBoundaryDescription': 'A separating line and points classified correctly or incorrectly.',
  'stories.lab.separatorTextEquivalent': 'Text equivalent of the points',
  'stories.lab.separatorPoint': (position: number) => `Point ${position}`,
  'stories.lab.separatorCorrect': 'correct',
  'stories.lab.separatorWrong': 'wrong',
  'stories.lab.separatorXorLimit': 'A single linear layer cannot separate every XOR arrangement.',
  'stories.lab.knowledgeChangedRule': 'Changed rule',
  'stories.lab.knowledgeAffectedRules': (count: number) => `${count} affected rules`,
  'stories.lab.knowledgeTree': 'Expert rule tree',
  'stories.lab.knowledgeTreeDescription': 'A rule tree and the dependent branches affected by a change.',
  'stories.lab.knowledgeSafety': 'This toy rule tree is an illustration, not medical advice.',
  'stories.lab.gradientRate': 'Learning rate',
  'stories.lab.gradientStep': 'Take one step',
  'stories.lab.gradientStatus': (x: number, loss: number) => `x ${x}; loss ${loss}`,
  'stories.lab.gradientLandscape': 'Loss landscape',
  'stories.lab.gradientLandscapeDescription': 'Squared loss around a fixed target.',
  'stories.lab.gradientTimeline': 'Funding and expectation timeline',
  'stories.lab.gradientTimelineCaveat': 'Explore this timeline independently; it is not one global AI-winter line.',
  'stories.lab.convolutionInput': 'Input image',
  'stories.lab.convolutionMoveUp': 'Move kernel up',
  'stories.lab.convolutionMoveDown': 'Move kernel down',
  'stories.lab.convolutionMoveLeft': 'Move kernel left',
  ...
  'stories.lab.convolutionGrouped': 'Grouped highlights are intuition only, not a GPU benchmark.',
  'stories.lab.attentionContext': 'Context',
  'stories.lab.attentionToken': (position: number, token: string) => `Token ${position}: ${token}`,
  'stories.lab.attentionSelectedWeights': (weights: string) => `Selected attention weights: ${weights}`,
  'stories.lab.attentionMap': 'Attention-weight map',
  'stories.lab.attentionMapDescription': 'Precomputed weights from the selected token to every token in this context.',
  'stories.lab.attentionTable': 'Attention weights as a table',
  'stories.lab.attentionTokenColumn': 'Token',
  'stories.lab.attentionWeightColumn': 'Weight',
  'stories.lab.attentionCaveat': 'Attention maps are not a full explanation of model reasoning.',
  'stories.lab.agentPermissions': 'Configured permissions',
  'stories.lab.agentTrace': 'Agent trace',
  'stories.lab.agentComplete': 'complete',
  'stories.lab.agentBlocked': 'blocked',
  'stories.lab.agentAwaitingHuman': 'awaiting-human',
  'stories.lab.agentPermission': (permission: string) => `Permission: ${permission}`,
  'stories.lab.agiFirstDefinition': 'First definition',
  'stories.lab.agiSecondDefinition': 'Second definition',
  'stories.lab.agiGenerality': 'Generality',
  'stories.lab.agiCapability': 'Capability',
  'stories.lab.agiAutonomy': 'Autonomy',
  'stories.lab.agiAxis': 'Axis',
  'stories.lab.agiDifferenceTable': 'Definition differences',
  'stories.lab.agiDifference': 'Difference (first − second)',
  'stories.lab.agiConclusion': 'Definition disagreement matters because people with decision power choose which threshold and consequences count.',
  ...
  'search.count': (n: string, q: string) => `${n} results for “${q}”`,
  ...
  'sidebar.filterNoMatch': 'No chapter matches.',
  'sidebar.filterClear': 'Clear the filter',
  ...
  'landing.question': 'Read closely, touch the idea, ask until it clicks.',
  'landing.question.read': 'Read closely,',
  'landing.question.touch': 'touch the idea,',
  'landing.question.ask': 'ask until it clicks.',
  'landing.lede': 'Detailed textbooks, with interactive figures you can try for yourself. When you want to go deeper, the AI tutor reads the lesson and your notes, then continues from the point where you are stuck.',
  'landing.read.verb': 'Open a lesson',
  'landing.read.catalog': 'Open the course catalog',
  'landing.read.meta': 'Free to read, no account needed',
  'landing.account.cta': 'Create an account',
  'landing.depth.h': 'A lesson should do more than give you the answer.',
  'landing.depth.p1': 'Each textbook moves from intuition to argument, formula, example, and exercise. An idea gets enough room for you to see why it works, not merely remember the result.',
  'landing.depth.p2': 'Interactive figures sit beside the passage that needs them. Change a parameter and watch what moves — and what remains true.',
  'landing.depth.caption': 'The writing is the backbone. Figures and interaction open more layers of understanding.',
  'landing.lab.h': 'Touch the idea',
  'landing.lab.copy': 'Move the spread and watch five possibilities change together.',
  'landing.lab.slider': 'Amount of spread',
  'landing.lab.axisFocused': 'focused',
  'landing.lab.axisSpread': 'evenly spread',
  'landing.lab.observation': 'What you are observing',
  'landing.lab.focused': 'One possibility stands out.',
  'landing.lab.mixed': 'The possibilities are spreading out.',
  'landing.lab.even': 'The possibilities are nearly even.',
  'landing.lab.figure': 'A chart of five possibilities changing with the amount of spread.',
  'landing.demo.h': 'Still stuck? Ask inside the lesson.',
  'landing.demo.intro': 'Highlight the sentence that stopped you. Write one line about what is unclear. The tutor reads the lesson and that note before it answers.',
  'landing.demo.example': 'An example from a lesson',
  'landing.demo.sentence': 'The harder an outcome is to predict, the more information we gain by observing it.',
  'landing.demo.noteLabel': 'Your note',
  'landing.demo.note': 'Why does being harder to predict mean there is more information?',
  'landing.demo.tutorLabel': 'Tutor',
  'landing.demo.tutor': 'If the result is already certain, observing it tells us nothing new. The more surprising the result, the more we learn from that observation.',
  'landing.note.how': 'The note stays with the sentence; the answer starts from the exact place where you are thinking.',
  'landing.note.hover': 'Hover the note to see the line back to its sentence.',
  'landing.vision.figure': 'A graphite and watercolor illustration of an open technical textbook on a desk, filled with diagrams and graphs, with one golden line connecting the writing to the visual explanations.',
  'landing.catalog.h': 'Choose a book and begin.',
  'landing.catalog.error': 'The course catalog could not be loaded right now.',
  'landing.catalog.retry': 'Try again',
  'landing.catalog.all': 'Open the full catalog',
  'landing.footer.h': 'Still something you do not understand?',
  'landing.footer.start': 'Start there.',
  ...
  'login.legal.lead': 'By creating an account you agree to the',
  'login.legal.terms': 'Terms of Service',
  'login.legal.and': 'and the',
  'login.legal.privacy': 'Privacy policy',
  'legal.updated': 'Updated',
  'legal.browseCourses': 'Browse courses',
  'settings.legal.blurb': 'A non-commercial community project. Most of the content is AI-generated — verify it before you rely on it.',
  'footer.nav': 'Legal links',
  'settings.legal.title': 'About the project',
