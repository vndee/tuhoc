...
export const en: Messages = {
  ...
  'landing.question': 'Where you teach yourself and dig deeper — with AI helping exactly where you get stuck.',
  'landing.lede': 'Read the textbook free, no account needed. Highlight a sentence and the note sticks to it — and the AI tutor answers right there.',
  'landing.read.h': 'Read',
  ...
  'landing.demo.h': 'How it works (example)',
  ...
  'landing.demo.tutor': 'Answers that exact spot, holding your own note:',
  'landing.working.tried': 'read it a third time',
  'landing.working.verdict': 'still stuck in the same place',
  'landing.note.h': 'Margin note (example)',
  'landing.note.how': 'The note anchors to that exact sentence and stays there.',
  'landing.note.hover': 'Hover the note to see the chalk run back to its sentence.',
  'landing.ask.h': 'Ask the tutor (example)',
  'landing.ask.you': 'You',
  'landing.ask.tutor': 'Tutor',
  'landing.ask.margin.h': 'What the tutor knows',
  'landing.ask.margin.p': 'Your notes — on by default, switchable in Settings. Paid with your account’s credit; no key of your own.',
  ...
  'landing.vision.body': 'A good book is a spine, not a ceiling. You still do the work; the AI only makes that work reach further.',
  'landing.vision.figure': 'A chalk drawing: someone sitting over an open book, and around them the things they are learning — a neural network, a few equations, a ringed planet and some stars.',
  'landing.can.h': 'What you can do here',
  'landing.can.read': 'Read — long textbooks, formulas, interactive figures. Free.',
  'landing.can.note': 'Note — highlight a sentence; the note sticks to that sentence.',
  'landing.can.ask': 'Ask — the tutor answers inside the chapter, reading your notes.',
  'landing.can.return': 'Come back — any machine opens where you left off.',
