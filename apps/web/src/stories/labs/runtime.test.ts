...
const definitions: LabDefinition[] = [
  ...
  { kind: 'agi-definitions', title: localized('AGI', 'AGI'), instruction: localized('Thử', 'Try'), config: { definitions: [{ id: 'd-1', label: 'D1', note: localized('Một', 'One'), generality: 1, capability: 1, autonomy: 1 }, { id: 'd-2', label: 'D2', note: localized('Hai', 'Two'), generality: 2, capability: 2, autonomy: 2 }, { id: 'd-3', label: 'D3', note: localized('Ba', 'Three'), generality: 3, capability: 3, autonomy: 3 }] } },
];
