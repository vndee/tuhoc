...
import { type CardFocus, MarginCards } from './MarginCards';
 ...
 */
function Harness({ html, visible = true }: { html: string; visible?: boolean }) {
  ...
  return (
    <>
      ...
      <aside data-testid="rail">
        <MarginCards content={content} store={store} visible={visible} focus={focus} onFocusChange={setFocus} />
      </aside>
    </>
  );
}
