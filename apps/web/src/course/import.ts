...
const FINDING_KEY: Readonly<Record<ImportFindingCode | FindingCode, MessageKey>> = {
  ...
  WIDGET_TOO_LARGE: 'finding.WIDGET_TOO_LARGE',
  WIDGET_LINE_TOO_LONG: 'finding.WIDGET_LINE_TOO_LONG',
  WIDGET_BAD_NAME: 'finding.WIDGET_BAD_NAME',
  WIDGET_FORBIDDEN_API: 'finding.WIDGET_FORBIDDEN_API',
  WIDGET_EXTERNAL_URL: 'finding.WIDGET_EXTERNAL_URL',
  WIDGET_EXTRA_FILE: 'finding.WIDGET_EXTRA_FILE',
  WIDGET_MISSING: 'finding.WIDGET_MISSING',
  WIDGET_ORPHAN: 'finding.WIDGET_ORPHAN',
